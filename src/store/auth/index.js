...
const authModule = {
  ...
  actions: {
    login: async function ({ commit }, { username, password }) {
      try {
        commit('setProcessing', { show: true, message: null }, { root: true }); // this mutation is in the root
        ...
        commit('setNotification', {
          ...
          { root: true }); // this mutation is in the root
        ...
        commit('setProcessing', { show: false, message: null }, { root: true }); // this mutation is in the root
      }
    },
